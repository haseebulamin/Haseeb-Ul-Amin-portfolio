    ...
    <div id="home" className="text-white h-screen overflow-hidden">
      ...
      <div className="col-lg-6 order-lg-last  flex align-items-center justify-content-center animate__fadeInRight animate__animated"> 
        ...
        <div className="col-lg-6  order-lg-first flex flex-column justify-content-center animate__fadeInLeft animate__animated">
          ...
          <div className="button inline-block mr-2 mt-2" ><a type="button" href="#about" className="no-underline main-color px-4 py-2 bg-low font-normal text-md border-round-3xl bg-transparent overflow-hidden relative ">More About me</a></div>
          <div className="button inline-block ml-2 mt-2" ><a type="button" href="https://drive.google.com/file/d/1URF70eSYBImhjz0kM2muLwqdcE3WUIcF/view" target="_blank"  className="no-underline bg-low main-color px-4 py-2 font-normal text-md border-round-3xl bg-transparent overflow-hidden relative ">Download CV</a></div>
          </div>
        </div>
