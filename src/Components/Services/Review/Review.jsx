    ...
    <div id="carouselExampleCaptions" className="carousel slide overflow-hidden" data-bs-ride="false" >
        <div className="grid">
          <div className=" col-12  ">
            <div className='text-center pt-5'><p className='review-title text-xl inline-block font-bold uppercase main-color pl-6'>Client Says</p></div>
            <div className="carousel-inner ">
            <div className="carousel-item active">
            <div className=" flex flex-column align-items-center justify-content-center">
            <img src={client1} className="clienttImg border-circle my-5" height={220} width={220} alt="" />
            <h5 className="text-3xl  main-color font-bold">Ven Humesh</h5>
            <p className="text-xl text-white text-center w-7">
            ...
            <img src={client2} className="clienttImg border-circle my-5" height={220} width={220} alt="" />
            <h5 className="text-3xl  main-color font-bold">Theristen Dixon</h5>
            <p className="text-xl text-white text-center w-7">
            ...
            <img src={client3} className="clienttImg border-circle my-5" height={220} width={220} alt="" />
            <h5 className="text-3xl  main-color font-bold">Uvais ur Rehman</h5>
            <p className="text-xl text-white text-center w-7">
            ...
            <div className="buton text-center border-0 my-4">
