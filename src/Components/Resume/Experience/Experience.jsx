...
export default function Experience() {
  ...
  <div class="row g-0 p-2 ">
    <div class="col-2 flex justify-content-center align-items-center border-right-1">
  ...
  <div class="row g-0 p-2 ">
    ...
    <div class="col-10 p-0">
      <div class="card-body py-0 pr-0 pl-3 mt-2">
      <div className='text-2xl font-bold'>TechDev - <span className='font-medium'>UI Design</span></div>
