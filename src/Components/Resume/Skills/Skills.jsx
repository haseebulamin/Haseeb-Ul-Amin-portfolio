...
export default function Skills() {
  return (
    <div id='skills' className='text-white'>
     <div className='text-center py-4'><p data-aos="zoom-in"  data-aos-offset="100" className='title-line text-xl inline-block font-bold uppercase main-color pl-6 '>Skills</p></div>
     <div className="row g-0">
        <div className="col-lg-6 p-5 flex flex-column justify-content-center animate__animated animate__fadeInLeft">
        <h1 className='font-semibold text-6xl' data-aos="fade-right">Every <span className='main-color'>skill</span> you acquire doubles your odds of <span className='main-color'>success</span></h1>
        </div>
        <div className="col-lg-6 p-5 ">
            <div className="row g-0">
            <div className="col-6 my-3" data-aos="fade-down">
            ...
            <div className="col-6 my-3" data-aos="fade-down" data-aos-offset="100">
