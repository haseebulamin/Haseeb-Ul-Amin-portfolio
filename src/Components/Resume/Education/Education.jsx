...
return (
<div id="education" >
    <div className="py-4 text-center"><p data-aos="zoom-in" className='title-line text-xl main-color inline-block font-bold uppercase pl-6'>Education</p></div>
<div className="row text-white  g-0 ">
  <div className="col-lg-6 p-5 flex flex-column justify-content-center ">
    <h1 className='font-semibold text-6xl' data-aos="fade-right">Learning experiance in a <span className='main-color'>Various institutions</span></h1>
  </div>
  <div className="col-lg-6 flex justify-content-center  px-3" data-aos="fade-left">
