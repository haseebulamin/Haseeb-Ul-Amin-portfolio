  ...
  return (
    ...
    <div className='text-center pt-4 ' ><p data-aos="zoom-in" className='title-line text-xl inline-block font-bold uppercase main-color pl-6'>About me</p></div>
      ...
      <div className="col-lg-7  flex flex-column justify-content-center px-7 py-5">
        ...
        <p data-aos="fade-down">Actively applying my skills, I've initiated minor projects to further enhance my capabilities. Beyond academics, I thrive in extracurriculars, participating in hackathons, coding competitions, and bootcamps, fostering collaboration and innovative problem-solving.</p>
        <p data-aos="fade-down" className='main-color font-bold uppercase text-lg'>My Vision</p>
        <p data-aos="fade-down">I'm driven to blend theoretical insights with hands-on innovation. My goal is to craft visually stunning interfaces that redefine user experiences. I aspire to architect dynamic applications, pushing the boundaries of interactivity and contributing to the forefront of web development.</p>
        <div className="button inline-block mr-2 mt-2" ><Link data-aos="fade-down" type="button" to="/resume" className="bt no-underline main-color px-4 py-2 bg-low font-normal text-md border-round-3xl bg-transparent overflow-hidden relative ">Resume</Link></div>
      </div>
    </div>
  </div>
  )
